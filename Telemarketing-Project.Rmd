...
# (100 * success rate * 1)
(profit_per_100_1 <- (100 * (num_calls_made_1 / num_potential_calls_1) * success_rate_cluster1 * 6) - (100 * success_rate_cluster1 * 1))

# 5: Also, calculate what the profit is for this chosen model of this cluster
(profit_1 <- (num_calls_made_1 * success_rate_cluster1 * 6) - (num_calls_made_1 * success_rate_cluster1 * 1))
```
