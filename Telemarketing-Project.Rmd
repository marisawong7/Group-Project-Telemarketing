...
For cluster 1, we have chosen a logistic regression model since it has the largest profit per 100 people ($2.072539). In addition, the cluster only calls 32 people, so it will not be very time consuming to call all these people.
